...
class Pv2RowMapping extends MapFunction[PVEvent.Entity, RowSerializable] {
    ...
    override def map(event: PVEvent.Entity): RowSerializable = {
        ...
        rowSerializable.setField(16, 121)
        ...
        rowSerializable.setField(38, 12)
        rowSerializable.setField(39, "cm")
        rowSerializable.setField(40, 66)
        ...
        rowSerializable.setField(45, 121212121L)
        rowSerializable.setField(46, 1212112L)
        rowSerializable.setField(47, 12121L)
        rowSerializable.setField(48, 12121L)
        rowSerializable.setField(49, 3232L)
        rowSerializable.setField(50, 1131L)
        rowSerializable.setField(51, 2121L)
        rowSerializable.setField(52, 12121L)
        rowSerializable.setField(53, 2121L)
