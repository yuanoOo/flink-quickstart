...
public class HBaseSink<IN> {
    ...
    public abstract static class HBaseSinkBuilder<IN> {
        ...
        protected HBaseBuilder tableBuilder;
         ...
         * @return
         */
        public HBaseSinkBuilder<IN> setFlushPeriod(int seconds) {
            tableBuilder.setFlushPeriod(seconds);
            return this;
        }
         ...
         * @return
         */
        public HBaseSinkBuilder<IN> setBufferSize(long bufferSize) {
            tableBuilder.setBufferSize(bufferSize);
            return this;
        }
    ...
    public static class HBaseTupleSinkBuilder<IN extends Tuple> extends HBaseSinkBuilder<IN> {
        ...
        @Override
        protected HBaseSink<IN> createSink() {
    ...
    public static class HBaseRowSinkBuilder extends HBaseSinkBuilder<Row> {
        ...
        @Override
        protected HBaseSink<Row> createSink() {
